...
class Gaussian {
 public:
  ...
  Gaussian(const Eigen::VectorXd& mean, const Eigen::MatrixXd& covariance) {
 ...
 private:
  ...
  inline static const std::string dimensionality_mismatch() {
    return "Dimensionality mismatch";
  }

  inline static const std::string covariance_not_invertible() {
    return "Covariance matrix is not invertible";
  }
};
} // namespace gmms
