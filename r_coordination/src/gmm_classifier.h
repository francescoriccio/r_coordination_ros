...
class GMMClassifier {
 public:
  ...
  GMMClassifier(const double delta,
 ...
 private:
  ...
  inline static const std::string nottrained_() {
    return "The model has not been trained";
  }

  inline static const std::string dimensionality_mismatch_() {
    return "Dimensionality mismatch";
  }

  inline static const std::string notsufficient_() {
    return "Class data size not sufficient: skipping class";
  }
};
} // namespace gmms
